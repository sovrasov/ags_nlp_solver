...
python2 ../experiments/solve_examin.py --bin_path ../../globalizer/_bin/ --algo_capture AGSl --verbose --max_iters 350000 --problems_dim 5 --problems_class gklss --r 4 --lm 5 --eps 0.01 --stats_fname ../experiments/gklss5d/agsl_examin.json
