...
do
   echo "$algo"
   python2 ../experiments/solve_different_methods.py --verbose --dist_stop --max_iters 8000 --problems_dim 2 --problems_class gklss --algo $algo --stats_fname ../experiments/gklss2d/ags_r.json
done
