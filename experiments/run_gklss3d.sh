...
do
   echo "$algo"
   python2 ../experiments/solve_different_methods.py --verbose --dist_stop --max_iters 15000 --problems_dim 3 --problems_class gklss --algo $algo --stats_fname ../experiments/gklss3d/ags_r.json
done
