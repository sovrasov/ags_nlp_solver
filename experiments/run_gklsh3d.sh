...
do
   echo "$algo"
   python2 ../experiments/solve_different_methods.py --verbose --dist_stop --max_iters 25000 --problems_dim 3 --problems_class gklsh --algo $algo --stats_fname ../experiments/gklsh3d/ags_r.json
done
